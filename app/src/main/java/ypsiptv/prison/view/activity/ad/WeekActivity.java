...
import ypsiptv.prison.view.activity.ad.bean.MaterialType;
import ypsiptv.prison.view.activity.ad.bean.MaterialVO;
import ypsiptv.prison.view.activity.ad.bean.ProgramContentVO;
import ypsiptv.prison.view.activity.ad.bean.ProgramListVO;
import ypsiptv.prison.view.activity.ad.bean.ProgramVO;
import ypsiptv.prison.view.activity.ad.download.ZipUtil;
...
//                    System.out.println(pathList.size());
    ...
    private void background(ProgramVO p) {
        try {
            ...
            if (type == MyApp.ScreenType.VERTICAL) {
                setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
            } else if (type == MyApp.ScreenType.HORIZONTAL) {
    ...
    private void initData(String fname, String main) {
        try {
            ...
            prolistVO = MyApp.gson.fromJson(main, ProgramListVO.class);
            msgname.setText("正在插播" + prolistVO.getName());
